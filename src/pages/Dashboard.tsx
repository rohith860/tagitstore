...
export default function Dashboard() {
  ...
  const generateReport = () => {
    try {
      ...
      report.save(
        "TAGITStore-Dashboard-Report.pdf"
      );
    } catch (error) {
      console.error(
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-2xl">
              <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1.5 text-sm font-semibold text-white backdrop-blur-sm">
                <span>🚀</span>
                Welcome back
              </div>
              ...
              <p className="mt-3 max-w-xl text-sm leading-6 text-indigo-50 sm:text-base">
      ...
      <section className="mb-6 grid grid-cols-1 gap-6 xl:grid-cols-3">
        ...
        >
          <div className="mb-5">
            ...
            <p className="mt-1 text-sm font-medium text-slate-600 dark:text-slate-400">
              Access important store actions
              quickly.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-5 w-5 text-indigo-500 transition group-hover:translate-x-1 dark:text-indigo-400" />
              </div>

              <h3 className="mt-5 text-base font-bold text-indigo-950 dark:text-indigo-200">
                Add Product
              </h3>

              <p className="mt-1 text-sm font-medium text-indigo-800 dark:text-indigo-300/70">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-5 w-5 text-cyan-500 transition group-hover:translate-x-1 dark:text-cyan-400" />
              </div>

              <h3 className="mt-5 text-base font-bold text-cyan-950 dark:text-cyan-200">
                View Orders
              </h3>

              <p className="mt-1 text-sm font-medium text-cyan-800 dark:text-cyan-300/70">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-5 w-5 text-emerald-500 transition group-hover:translate-x-1 dark:text-emerald-400" />
              </div>

              <h3 className="mt-5 text-base font-bold text-emerald-950 dark:text-emerald-200">
                Add Customer
              </h3>

              <p className="mt-1 text-sm font-medium text-emerald-800 dark:text-emerald-300/70">
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-5 w-5 text-orange-500 transition group-hover:translate-x-1 dark:text-orange-400" />
              </div>

              <h3 className="mt-5 text-base font-bold text-orange-950 dark:text-orange-200">
                View Analytics
              </h3>

              <p className="mt-1 text-sm font-medium text-orange-800 dark:text-orange-300/70">
